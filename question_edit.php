...
if(isset($_POST['submit'])){
	update_question($_REQUEST["q_id"],$_POST['question'],$_POST['option_one'],$_POST['option_two'],$_POST['option_three'],$_POST['option_four'],$_POST['answer']);
	$success_msg.= '
...
<html>
    ...
    <body>
        ...
        <div class="container">
			...
			echo $success_msg;
				$k = $_REQUEST["q_id"];
				$questions = get_question_for_edit($k);
			?>
