...
if(isset($_POST['submit'])){
	update_passage($_REQUEST["id"],$_POST['passage']);
	$success_msg.= '
    ...
    <body>
        ...
        <div class="container">
			<?php
				echo $success_msg;
				$k = $_REQUEST["id"];
				$passages = get_passage_for_edit($k);
			?>
			...
			<form method="post">
				...
				<div class="form-group row">
					...
					<div class="col-10">
						<textarea class="form-control" name="passage" rows="6"><?php echo $passages['passage']; ?></textarea> 
					</div>
				</div>
