...
if(isset($_POST['submit'])){
	$q_id = get_q_id($_REQUEST["id"]);
	add_question($_REQUEST["id"],$q_id,$_POST['question'],$_POST['option_one'],$_POST['option_two'],$_POST['option_three'],$_POST['option_four'],$_POST['answer']);
	$success_msg.= '
        ...
        <div class="container">
			...
			<form method="post" onsubmit="check_ans()">
				...
				<span style="float: right;">
					<a href="reading_list.php?passage=<?php echo $_REQUEST["id"][0] ?>">
